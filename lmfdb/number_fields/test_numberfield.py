...
class NumberFieldTest(LmfdbTest):
    ...
    def test_search_multiple_fields(self):
        ...
        self.check_args('/NumberField/?jump=2.2.5.1%2c+3.3.49.1&search=Go', '2.2.5.1') # should find first field
        self.check_args('/NumberField/?jump=2.2.5.1%2c+3.3.49.1&search=Go', '3.3.49.1') # should find second field
        # Test comma-separated list with different input formats
        self.check_args('/NumberField/?jump=Qsqrt5%2c+x%5E2-3&search=Go', '2.2.5.1') # should find Qsqrt5
        self.check_args('/NumberField/?jump=Qsqrt5%2c+x%5E2-3&search=Go', '2.2.3.1') # should find x^2-3
